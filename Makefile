...
DIST_COMMON = $(top_srcdir)/common.am $(srcdir)/Makefile.in \
	$(srcdir)/Makefile.am $(top_srcdir)/configure \
	$(am__configure_deps) $(srcdir)/polygraph.man.in \
	$(notrans_dist_man7_MANS) $(dist_doc_DATA) INSTALL README TODO \
	cfgaux/ar-lib cfgaux/compile cfgaux/config.guess \
	cfgaux/config.sub cfgaux/install-sh cfgaux/missing \
	cfgaux/ltmain.sh $(top_srcdir)/cfgaux/ar-lib \
...
ACLOCAL = ${SHELL} /home/polygraph/src/polygraph-4.9.0/cfgaux/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/polygraph/src/polygraph-4.9.0/cfgaux/missing autoconf
AUTOHEADER = ${SHELL} /home/polygraph/src/polygraph-4.9.0/cfgaux/missing autoheader
AUTOMAKE = ${SHELL} /home/polygraph/src/polygraph-4.9.0/cfgaux/missing automake-1.14
AWK = gawk
CC = gcc
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /home/polygraph/src/polygraph-4.9.0/cfgaux/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
PACKAGE_STRING = Web Polygraph 4.9.0
...
STRIP = strip
VERSION = 4.9.0
abs_builddir = /home/polygraph/src/polygraph-4.9.0
abs_srcdir = /home/polygraph/src/polygraph-4.9.0
abs_top_builddir = /home/polygraph/src/polygraph-4.9.0
abs_top_srcdir = /home/polygraph/src/polygraph-4.9.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/polygraph/src/polygraph-4.9.0/cfgaux/install-sh
...
top_builddir = .
top_srcdir = .
SUBDIRS = . src workloads tools import
dist_doc_DATA = \
	CONTRIBUTORS \
	LICENSE \
	NOTICE \
...
installdirs-am:
	for dir in "$(DESTDIR)$(man7dir)" "$(DESTDIR)$(docdir)"; do \
